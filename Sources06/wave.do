...
add wave -noupdate /MIPS_Processor_TB/DUV/Jump_OR_Jal_wire
add wave -noupdate /MIPS_Processor_TB/DUV/PC_4OrBranchAddr_wire
add wave -noupdate /MIPS_Processor_TB/DUV/JumpAddr_wire
add wave -noupdate /MIPS_Processor_TB/DUV/PC4OrBranchAddr_OR_JumpAddr_wire
...
add wave -noupdate -color {Medium Orchid} -label {        s0} /MIPS_Processor_TB/DUV/Register_File/Register_s0/DataOutput
add wave -noupdate -color {Medium Orchid} -label {        s1} /MIPS_Processor_TB/DUV/Register_File/Register_s1/DataOutput
add wave -noupdate -color {Medium Orchid} -label {        s2} /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_18
add wave -noupdate -color {Medium Orchid} -label {        s3} /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_19
add wave -noupdate -color {Medium Orchid} -label {        s7} /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_23
...
WaveRestoreCursors {{Cursor 1} {49 ps} 0} {{Cursor 2} {17 ps} 0} {{Cursor 3} {400 ps} 0}
