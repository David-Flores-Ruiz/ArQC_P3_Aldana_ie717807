...
add wave -noupdate -radix hexadecimal /MIPS_Processor_TB/DUV/PC_4_wire
...
add wave -noupdate -color Orange /MIPS_Processor_TB/DUV/ControlUnit/OP
add wave -noupdate -color Orange /MIPS_Processor_TB/DUV/ControlUnit/FUNCT
add wave -noupdate -color Orange /MIPS_Processor_TB/DUV/ControlUnit/OP_FUNCT
add wave -noupdate -color Orange /MIPS_Processor_TB/DUV/ControlUnit/Jr
add wave -noupdate -divider {MUX $ra Address}
add wave -noupdate -color {Medium Orchid} /MIPS_Processor_TB/DUV/MEM_WB_Jal_zero
add wave -noupdate -color {Medium Orchid} /MIPS_Processor_TB/DUV/MEM_WB_WriteRegister_wire
add wave -noupdate -color {Medium Orchid} /MIPS_Processor_TB/DUV/Direction_RA_wire
add wave -noupdate -color {Medium Orchid} /MIPS_Processor_TB/DUV/WriteRegisterFINAL_wire
add wave -noupdate -divider {MUX $ra DATA}
add wave -noupdate /MIPS_Processor_TB/DUV/MEM_WB_Jal_zero
add wave -noupdate /MIPS_Processor_TB/DUV/MEM_WB_PC4_wire
add wave -noupdate /MIPS_Processor_TB/DUV/ALUResultOrRamData_wire
add wave -noupdate /MIPS_Processor_TB/DUV/ALUOrRam_AND_RegA_wire
add wave -noupdate -divider {REGISTER FILE}
add wave -noupdate -color Coral /MIPS_Processor_TB/DUV/MEM_WB_RegWrite_wire
add wave -noupdate -color Coral /MIPS_Processor_TB/DUV/WriteRegisterFINAL_wire
add wave -noupdate -color Coral /MIPS_Processor_TB/DUV/ALUOrRam_AND_RegA_wire
add wave -noupdate -divider {Restador en IF/ID}
add wave -noupdate -color Turquoise /MIPS_Processor_TB/DUV/Exor
add wave -noupdate -color Turquoise /MIPS_Processor_TB/DUV/Zero_Exor
add wave -noupdate -divider {HAZARD UNIT}
add wave -noupdate /MIPS_Processor_TB/DUV/HazardUnit/ID_EX_MemRead_i
add wave -noupdate /MIPS_Processor_TB/DUV/HazardUnit/IF_ID_Rs_i
add wave -noupdate /MIPS_Processor_TB/DUV/HazardUnit/IF_ID_Rt_i
add wave -noupdate /MIPS_Processor_TB/DUV/HazardUnit/ID_EX_Rt_i
add wave -noupdate -color Yellow /MIPS_Processor_TB/DUV/HazardUnit/PCWrite_o
add wave -noupdate -color Yellow /MIPS_Processor_TB/DUV/HazardUnit/IF_ID_Write_o
add wave -noupdate -color Yellow /MIPS_Processor_TB/DUV/HazardUnit/sel_bubble_o
...
add wave -noupdate /MIPS_Processor_TB/DUV/EX_MEM_RegWrite_wire
add wave -noupdate /MIPS_Processor_TB/DUV/MEM_WB_RegWrite_wire
add wave -noupdate /MIPS_Processor_TB/DUV/ForwardA_wire
add wave -noupdate /MIPS_Processor_TB/DUV/ForwardB_wire
add wave -noupdate -divider Registros
add wave -noupdate -label {        at} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_1
add wave -noupdate -color Yellow -label {        t0} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_8
add wave -noupdate -color Yellow -label {        t1} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_9
add wave -noupdate -color Yellow -label {        t2} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_10
add wave -noupdate -color Yellow -label {        t3} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_11
add wave -noupdate -color Yellow -label {        t4} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_12
add wave -noupdate -color Yellow -label {        t5} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_13
add wave -noupdate -color Yellow -label {        t6} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_14
add wave -noupdate -color Yellow -label {        t7} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_15
add wave -noupdate -color {Medium Orchid} -label {        s0} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/Register_s0/DataOutput
add wave -noupdate -color {Medium Orchid} -label {        s1} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/Register_s1/DataOutput
add wave -noupdate -color {Medium Orchid} -label {        s2} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_18
add wave -noupdate -color {Medium Orchid} -label {        s3} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_19
add wave -noupdate -color {Medium Orchid} -label {        s7} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_23
add wave -noupdate -color Cyan -label {       $sp} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_29
add wave -noupdate -color Green -label {       $ra} -radix hexadecimal /MIPS_Processor_TB/DUV/Register_File/MUXRegister1/Data_31
...
add wave -noupdate -divider {ERROR con banderas Sw ID_EX}
add wave -noupdate /MIPS_Processor_TB/DUV/ID_EX_RegWrite_wire
add wave -noupdate /MIPS_Processor_TB/DUV/ID_EX_MemtoReg_wire
add wave -noupdate /MIPS_Processor_TB/DUV/ID_EX_RegDst_wire
add wave -noupdate /MIPS_Processor_TB/DUV/RegWrite_wire
add wave -noupdate /MIPS_Processor_TB/DUV/MemtoReg_wire
add wave -noupdate /MIPS_Processor_TB/DUV/RegDst_wire
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {6 ps} 0} {{Cursor 2} {38 ps} 0} {{Cursor 3} {400 ps} 0}
